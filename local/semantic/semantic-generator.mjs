...
function promptText(observation) {
  return [
    ...
    "Open substantive collapsed sections through their observed summary, disclosure, or aria-expanded controls before terminal progression. A link whose href already points to a confirmation, success, submitted, or thank-you route is terminal-looking, not a disclosure; never use such a link to bypass still-hidden applicant controls or a disabled real submit control.",
