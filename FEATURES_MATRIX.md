...
| Predictable obstacles | `F1.6` | **Partial** | Stable waits, a fixed pointer sweep, and bounded reversible scrolling across the main document, reachable frames, and nested scroll surfaces are generic physics before novel-state sensing. Cookie gates and every visible collapsed expando/disclosure are LLM-authored actions and never applicant fields. Complete broad public-site proof remains. |
