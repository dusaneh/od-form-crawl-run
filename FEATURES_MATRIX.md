...
| Automated tests | `F8` | **Partial** | Production build and 84 executable automated checks pass, with one optional PostgreSQL integration check skipped without its dedicated test URI. Authenticated production smoke and the blind corpus are green; public D5 remains. |
